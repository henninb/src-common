...
procedure date_today is
  ...
  begin
    ...
    put_line("utc=<" & Integer'Image(years) & "-" & Integer'Image(months) & "-" & Integer'Image(days) & Integer'Image(hours) & ":" & Integer'Image(mins) & ":" & Integer'Image(secs) & ">");
  ...
  procedure date_today is
    ...
    utc : Ada.Calendar.time := Ada.Calendar.Clock;
    years : integer;
    months : integer;
    days : integer;
    hours : integer;
  ...
  --secs := GNAT.Calendar.Second(utc);
    ...
    put_line("local=<" & Integer'Image(years) & "-" & Integer'Image(months) & "-" & Integer'Image(days) & Integer'Image(hours) & ":" & Integer'Image(mins) & ":" & Integer'Image(secs) & ">");
  end date_today;
begin
